...
const index = 3;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-D_bP2qrC.js')).default;
const universal_id = "src/routes/accommodations/+page.ts";
const server_id = "src/routes/accommodations/+page.server.ts";
...
//# sourceMappingURL=3-R_MjfLzf.js.map
