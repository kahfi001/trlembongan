...
const index = 7;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-C9iwZPkH.js')).default;
const universal_id = "src/routes/contact-us/+page.ts";
...
//# sourceMappingURL=7-D3K-ZGiN.js.map
