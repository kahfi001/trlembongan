...
import { g as getDining } from './dining-CKKpOrfh.js';
...
const index = 8;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-BIlbRQSZ.js')).default;
const universal_id = "src/routes/dine/+page.ts";
const server_id = "src/routes/dine/+page.server.ts";
...
//# sourceMappingURL=8-B-0XiNnA.js.map
