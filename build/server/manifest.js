...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-DOCgWSza.js')),
			__memo(() => import('./chunks/1-BM3_aBAO.js')),
			__memo(() => import('./chunks/2-O04EdmMB.js')),
			__memo(() => import('./chunks/3-R_MjfLzf.js')),
			__memo(() => import('./chunks/4-BX-O8q--.js')),
			__memo(() => import('./chunks/5-DgMkuiVZ.js')),
			__memo(() => import('./chunks/6-Dx0bKbl-.js')),
			__memo(() => import('./chunks/7-D3K-ZGiN.js')),
			__memo(() => import('./chunks/8-B-0XiNnA.js')),
			__memo(() => import('./chunks/9-BisuiQRw.js')),
			__memo(() => import('./chunks/10-BwPv_Ppt.js')),
			__memo(() => import('./chunks/11-BvYQsHQv.js')),
			__memo(() => import('./chunks/12-DFYiVxtm.js')),
			__memo(() => import('./chunks/13-LUmBIwtx.js'))
		],
		routes: [
			{
				id: "/",
