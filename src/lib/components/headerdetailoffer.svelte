<script lang="ts">
    ...
    $: isContactus = $page.url.pathname.startsWith('/contact-us');
   ...
   // Fungsi untuk mendeteksi scroll tanpa menggunakan void
    ...
    onMount(() => {
        ...
        new Swiper(".myNavRoomSwiper", {
            direction: "horizontal",
            slidesPerView:2.1,
            spaceBetween: 20,
            navigation: {
                nextEl: '.swiper-button-next-navroom',
                prevEl: '.swiper-button-prev-navroom',
            },
            effect: "slide",
            speed:3000,
            // autoplay: {
...
<header>
    <!-- Desktop -->
    <nav class={`fixed top-0 z-30 w-full h-max px-16 py-8 hidden xl:flex justify-between items-center font-manrope uppercase transition-all bg-lightbg text-gold`}>
        ...
        <a href="{info[0].book_url}" class={`relative flex items-center  justify-center text-xl tracking-[0.15rem] font-medium group gap-3 2xl:py-6 2xl:px-12 xl:py-4 xl:px-10 duration-300 transition-all border border-gold `} > 
            book now
        </a>
    </nav>
    ...
    <div class="drawer z-50">
        ...
        <div class="drawer-side">
            ...
            <div class="bg-lightbg h-full w-screen">
                ...
                <!-- Header Drawer -->
                <div class="w-full h-max 2xl:px-20 px-16 py-8 hidden xl:flex justify-between items-center font-manrope uppercase fixed top-0 z-10 bg-lightbg">
                    <label  for="my-drawer-desktop" aria-label="close sidebar"  class="cursor-pointer drawer-overlay flex items-center justify-end 2xl:py-6 2xl:px-12 xl:py-4 xl:px-10  2xl:gap-4 xl:gap-3 2xl:text-xl xl:text-base tracking-[0.05rem] group text-gold">
                    ...
                    <a href="{info[0].book_url}" class={`relative flex items-center  justify-center text-xl tracking-[0.15rem] font-medium group gap-3 2xl:py-6 2xl:px-12 xl:py-5 xl:px-10 duration-300 transition-all border border-solid border-gold text-gold`} > 
                        book now
                    </a>
                </div>
...
<header class="block xl:hidden">
    <nav class="absolute top-10 left-0 flex justify-center items-center w-full z-10">
    ...
    <div class="fixed bottom-4 left-0 flex flex-col gap-4 w-full z-50 px-4 md:hidden">
